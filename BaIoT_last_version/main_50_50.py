...
for i in list_col:
    ...
    data_bt = pd.read_csv("D:/Documents/TalTech/BaIoT_new/" + i + "/benign_traffic.csv")
    data_a = pd.read_csv("D:/Documents/TalTech/BaIoT_new/" + i + "/attacks.csv")
...
df_report.to_csv('D:/Documents/TalTech/BaIoT_new/Results/Test_6/results_test_6.csv', sep=';')
