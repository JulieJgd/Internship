...
path = "D:/Documents/TalTech/BaIoT_new/"
...
for i in list_col:
    ...
    data_bt = pd.read_csv("D:/Documents/TalTech/BaIoT_new_2/50_50/" + i + "/benign_traffic.csv")
    data_a = pd.read_csv("D:/Documents/TalTech/BaIoT_new_2/50_50/" + i + "/attacks.csv")
    columns = data_bt.columns
    data_train = data_train.append(data_bt)
    data_train = data_train.append(data_a).sample(frac=1)

data_test = pd.DataFrame()
for i in list_col:
    path_1 = os.path.join(path, i)
    data_bt = pd.read_csv("D:/Documents/TalTech/BaIoT_new_2/90_10/" + i + "/benign_traffic.csv")
    data_a = pd.read_csv("D:/Documents/TalTech/BaIoT_new_2/90_10/" + i + "/attacks.csv")
    columns = data_bt.columns
    data_test = data_test.append(data_bt)
    data_test = data_test.append(data_a).sample(frac=1)

y_train = data_train[["Malware"]]
X_train = data_train[columns.drop("Malware")]
y_test = data_test[["Malware"]]
X_test= data_test[columns.drop("Malware")]
...
# minor_class = data_train[data_train["Malware"] == key]
...
df_report.to_csv('D:/Documents/TalTech/BaIoT_new_2/Results/Test_6/results_test_6.csv', sep=';')
